...
import { findAll, findById, create, elimina, update, uploadCover, addComment, updateComment, deleteComment, findMyPosts } from "../controllers/blogPosts.js";
import parser from "../middleware/cloudinary.js";
import { authentication } from "../middleware/authentication.js";

const blogPostRouter = express.Router();
blogPostRouter.get("/", authentication, findAll);
blogPostRouter.get("/me", authentication, findMyPosts);
